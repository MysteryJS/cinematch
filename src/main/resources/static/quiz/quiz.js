...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const translations = {
        en: {
            ...
            qTitle: "Movie Quiz — 10 Random Questions",
            qDesc: "Choose one of the 5 answers for each question. You will receive immediate feedback.",
        ...
        el: {
            ...
            qTitle: "Κουίζ Ταινιών — 10 Τυχαίες Ερωτήσεις",
            qDesc: "Επιλέξτε μία από τις 5 απαντήσεις. Θα λάβετε άμεση ενημέρωση και το τελικό σκορ.",
    ...
    langBtn.addEventListener("click", () => {
        ...
        navLinks[6].textContent = t.forum;
        if (navLinks[7]) navLinks[7].textContent = (navLinks[7].getAttribute('href').includes('login')) ? t.login : t.logout;

        document.querySelector(".page-header h1").textContent = t.qTitle;
        document.querySelector(".page-header p").textContent = t.qDesc;
        ...
        titles[0].textContent = t.menu;
        titles[1].textContent = t.follow;
